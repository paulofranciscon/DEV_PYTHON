...
resultado = Geocoder('AIzaSyDsF6-ETfWjCOTIxbwc6cnINqx8MNAeJho').geocode(endereco)
coordinates = Geocoder('AIzaSyDsF6-ETfWjCOTIxbwc6cnINqx8MNAeJho').geocode(endereco).coordinates
